...
PPOutline::PPOutline(){
	...
	CreateTargets(Vivid::GetFrameWidth(), Vivid::GetFrameHeight(), 2);
...
Texture2D* PPOutline::Process(Texture2D* frame) {
	...
	m_Draw->Rect(GetTexture(1), glm::vec2(0,0), glm::vec2(Vivid::GetFrameWidth(),Vivid::GetFrameHeight()), glm::vec4(1, 1, 1, 1));
