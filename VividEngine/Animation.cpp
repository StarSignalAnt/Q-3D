...
Animation::Animation(aiScene* scene, aiAnimation* anim, SkeletalMeshComponent* actor) {
...
void Animation::ReadMissingBones(aiAnimation* anim, SkeletalMeshComponent* actor) {
