...
namespace Q3D::Engine::Texture {
    ...
    Texture2D::Texture2D(std::string path, bool srgb)
    {
        ...
        */
        ...
        CreateTextureFromFile(path.c_str(), loadInfo, Q3D::Engine::QEngine::GetDevice(), &m_pTexture);
        Q3D::Engine::QEngine::GetContext()->Flush();
    ...
    Texture2D::Texture2D(int w, int h, float* data, int bpp)
    {
        ...
        Q3D::Engine::QEngine::GetDevice()->CreateTexture(TexDesc, &tdata, &pTexture);
        m_pTexture = pTexture;
    ...
    void Texture2D::Update(float* data) {
        ...
        Q3D::Engine::QEngine::GetContext()->UpdateTexture(m_pTexture, 0, 0, updateBox, subresourceData,
    ...
    std::vector<uint8_t> Texture2D::ExtractTextureData() {
        ...
        try {
            ...
            Q3D::Engine::QEngine::GetDevice()->CreateTexture(stagingDesc, nullptr, &stagingTexture);
            ...
            Q3D::Engine::QEngine::GetContext()->CopyTexture(copyAttribs);
            Q3D::Engine::QEngine::GetContext()->Flush();

            // Map staging texture and read data
            MappedTextureSubresource mappedData;
            Q3D::Engine::QEngine::GetContext()->MapTextureSubresource(stagingTexture, 0, 0, MAP_READ, MAP_FLAG_NONE, nullptr, mappedData);
            ...
            if (mappedData.pData) {
                ...
                Q3D::Engine::QEngine::GetContext()->UnmapTextureSubresource(stagingTexture, 0, 0);
            }
            else {
