    ...
    : m_Camera(node), m_Override(nullptr)
{
    ...
    Q3D::Engine::QEngine::GetDevice()->CreateBuffer(VertBuffDesc, nullptr, &m_VertexBuffer);
    ...
    Q3D::Engine::QEngine::GetDevice()->CreateBuffer(IdxBuffDesc, &IBData, &m_IndexBuffer);
}
...
void Draw2D::Rect(Q3D::Engine::Texture::Texture2D* image, glm::vec2 pos, glm::vec2 size, glm::vec4 color)
{
    ...
    v1.view = glm::vec4(Q3D::Engine::QEngine::GetScX(), Q3D::Engine::QEngine::GetScY(), Q3D::Engine::QEngine::GetScW(), Q3D::Engine::QEngine::GetScH());
    v2.view = v1.view;
    v3.view = v1.view;
    v4.view = v1.view;
...
void Draw2D::InternalFlush()
{
    ...
    void* pMappedData;
    Q3D::Engine::QEngine::GetContext()->MapBuffer(m_VertexBuffer, MAP_WRITE, MAP_FLAG_DISCARD, pMappedData);
    memcpy(pMappedData, m_BatchVertices.data(), m_BatchVertices.size() * sizeof(Draw2D_Vertex));
    Q3D::Engine::QEngine::GetContext()->UnmapBuffer(m_VertexBuffer, MAP_WRITE);
